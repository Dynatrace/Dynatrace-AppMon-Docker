...
# the environment.
COLLECTOR_HOST_NAME=${COLLECTOR_NAME:-"appmon_collector"}
COLLECTOR_PORT=${COLLECTOR_ENV_AGENT_PORT:-"9998"}
COLLECTOR=${AGENT_COLLECTOR_PORT:-"${COLLECTOR_HOST_NAME}:${COLLECTOR_PORT}"}
